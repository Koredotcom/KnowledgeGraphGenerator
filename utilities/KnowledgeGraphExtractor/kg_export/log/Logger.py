...
from kg_export.config.config import log as log_conf

LOG_FILENAME = log_conf.get("ONTOLOGY_ANALYZER_LOG")
...
class LoggerManager(Singleton):
    ...
    def init(self, loggername):
        ...
        formatter = logging.Formatter(
            fmt = log_conf.get("FORMAT_STRING")
        )
        rhandler.setFormatter(formatter)
        self.logger.addHandler(rhandler) if not self.logger.hasHandlers() else ''
        pass
