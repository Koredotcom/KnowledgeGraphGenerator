...
<table>
       ...
       <tr>
              ...
              <td> The path to the training data or a pretrained word2vec model. This can be either a PDF file or a ZIP containing PDFs or the path to a pretrained model. </td>
              <td> Optional </td>
              <td> None </td>
       </tr>
       <tr>
              <td> --training_data_type </td>
